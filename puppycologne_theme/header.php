																		...
																		<table class="image_block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
																			<tr>
																				<td style="width:100%;padding-right:0px;padding-left:0px;">
																					<div align="center" style="line-height:10px"><img class="big" src="<?php echo $ticket['WooCommerceEventsTicketHeaderImage']; ?>" style="display: block; height: auto; border: 0; width: 585px; max-width: 100%;" width="585"></div>
																				</td>
																			</tr>
																		</table>
																	</td>
													...
													<table class="image_block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td style="width:100%;padding-right:0px;padding-left:0px;padding-top:10px;padding-bottom:15px;">
																<div align="center" style="line-height:10px"><img src="<?php echo $ticket['WooCommerceEventsTicketLogo']; ?>" style="display: block; height: auto; border: 0; width: 168px; max-width: 100%;" width="168"></div>
															</td>
														</tr>
													</table>
												</td>
													...
													<table class="heading_block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td style="padding-bottom:10px;padding-top:15px;text-align:center;width:100%;">
																<h2 style="margin: 0; color: #393d47; direction: ltr; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 28px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder"><?php echo $ticket['name'] ?></span></h2>
															</td>
														</tr>
													</table>
															...
															<td style="text-align:center;width:100%;">
																...
																<?php
																														...
																														&& $ticket['WooCommerceEventsType'] == 'select' ) :
																															...
																															?>
																</br>																													<?php if ( $ticket['WooCommerceEventsType'] !== 'select' || $ticket['WooCommerceEventsSelectGlobalTime'] == 'on' ) : ?>
